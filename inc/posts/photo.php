<?php if (is_archive()){ ?>
  <div class="col-md-6 col-lg-4">
    <article class="h-entry post photo">
      <a class="photo-img photo-square" href="<?php the_permalink(); ?>">
        <img src="<?php the_field('photo'); ?>" alt="">
        <div class="photo-square-text">
...
<?php } else { ?>
  <article class="h-entry post <?php if (is_single()){ echo('single'); }?> photo row">
    <div class="col-lg-3">
      <p class="date">
    ...
    <div class="photo-img col-lg-9">
      <?php if (!is_single()){ ?>
        <h3 class="p-name post-title mt-0"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
      <?php } ?>
      <p class="mt-0"><img src="<?php the_field('photo'); ?>" alt=""></p>
      <?php the_content(); ?>
    </div>
  </article>
<?php } ?>